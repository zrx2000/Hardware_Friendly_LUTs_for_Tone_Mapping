...
def calculate_psnr(img1, img2, test_y_channel=True):
    ...
    Ref: https://en.wikipedia.org/wiki/Peak_signal-to-noise-ratio
    ...
    img1 = _convert_to_numpy(img1).astype(np.float64)
    img2 = _convert_to_numpy(img2).astype(np.float64)
